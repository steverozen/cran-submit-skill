...
- Writing `NEWS.md` or the "Submission" section of `cran-comments.md` —
  ...
  the prose is yours.
- Uploading to CRAN — you submit the tarball manually at
  <https://cran.r-project.org/submit.html> so you can click through
  the confirmation email CRAN sends to the maintainer address.
